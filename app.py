...
"""
        ...
        # Parsando as tags
        dados_ia, analise, estrategia, mensagem = '', '', '', ''
        
        match_d = re.search(r'\[DADOS\](.*?)\[ANALISE\]', texto, re.DOTALL)
